<?php $aData = Besearcher\View::data(); ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Besearcher - Dashboard</title>
        ...
        <?php if(!isset($aData['hideNavbar'])) { ?>
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="img/logo/logo-text.png" title="Besearcher logo" style="width: auto; height: 50px;"/></a>
                </div>
                <!-- /.navbar-header -->
                    ...
                    ?>
                        <li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                ...
                                <?php echo $aUser['name']; ?> <i class="fa fa-user fa-fw"></i> <i class="fa fa-caret-down"></i>
                            </a>
                            <ul class="dropdown-menu dropdown-user">
